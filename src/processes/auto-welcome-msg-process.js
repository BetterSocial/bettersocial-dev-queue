...
const automateWelcomeMsgProcess = async (job, done) => {
  ...
  try {
    ...
    if (channelState.messages.length <= 2) {
      const toBeSent = {
        text: `Hi **${resultPrepopulated.ownUser.username}**.<br> This is Bastian, Founder of Better Social (I’m not a bot, I promise!). Thanks for signing up as one of our first users, the team &amp; I really appreciates your support and I hope you will give us a chance in our fight to improve the broken social media landscape.<br> This is an uphill battle against giant corporations – I would love to hear from you how we can improve this app, and what would make it more likely for you to recommend the app to your friends and start posting here.<br> Any feedback &amp; criticism, but also questions are very welcome, and I promise to personally respond! Thank you so much!<br> &nbsp; Bastian`,
