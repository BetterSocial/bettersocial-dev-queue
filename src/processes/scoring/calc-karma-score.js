...
const combinedUserScore = async (userId, userScoreCol, sign_user_score, anonymousUserId = null) => {
...
const calcKarmaScore = async (userId, sign_user_score = null) => {
  ...
  const combined_user_score = await combinedUserScore(
    userId,
    userScoreCol,
    sign_user_score,
    anonymousUserId
