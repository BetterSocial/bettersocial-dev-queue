...
const initQueue = () => {
    ...
    BetterSocialQueue.setEventCallback(weeklyCredderUpdateQueue, credderWeeklyScoreProcess)
    BetterSocialQueue.setCron(weeklyCredderUpdateQueue, "0 12 * * *")

    BetterSocialQueue.setEventCallback(refreshUserFollowerCountMaterializedViewQueue, refreshUserFollowerCount)
    BetterSocialQueue.setCron(refreshUserFollowerCountMaterializedViewQueue, "0 * * * *")

    BetterSocialQueue.setEventCallback(refreshUserTopicMaterializedViewQueue, refreshUserTopicFollower)
